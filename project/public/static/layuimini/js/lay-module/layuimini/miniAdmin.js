 ...
 */
layui.define(
    ["jquery", "miniMenu", "element", "miniTab", "miniTheme"],
    function (exports) {
        var $ = layui.$,
            layer = layui.layer,
                ...
                $("body").on(
                    ...
                    function () {
                        ...
                        var classInfo = $(this).attr("class"),
                            ...
                            isShow =
                                $(".layuimini-tool i").attr("data-side-fold");
                        if (isShow == 0 && tips) {
                            tips =
                                "<ul class='layuimini-menu-left-zoom layui-nav layui-nav-tree layui-this'><li class='layui-nav-item layui-nav-itemed'>" +
                                tips +
                                "</li></ul>";
